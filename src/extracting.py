...
from equipment.analyzer_ryuhei_1 import VisualAnalyzer
from equipment.capture_video import CaptureVideo
...
# analyzer1のパラメータ（辞書型）
params1 = status['analyzer1_params']
...
def main():
    ...
    colors = [
        [0, 0, 255], [0, 128, 255], [255, 100, 255], [0, 255, 255], [0, 255, 0], [255, 0, 0],
    ...
    df = pd.DataFrame(feature_values, index=names, columns=analyzer.feature_names)
    df.index.name = '動画ID'
